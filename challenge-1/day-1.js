...
// transforming the string in an array
...
while (true) {
  ...
  if (!(accFrequenciesList.includes(accFrequency))) {
    ...
    break; // when the first duplicated frequency appears, the loop ends
  }
}

// showing the first frequency reaches twice
